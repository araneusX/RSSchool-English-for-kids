...
class Game {
  constructor(appData, category, onRight, onMistake, onEnd) {
    ...
    this.rightSound = new Audio('/src/assets/sound/right.mp3');
    this.mistakeSound = new Audio('/src/assets/sound/mistake.mp3');
  ...
  play() {
    if (!this.isProgress) {
      ...
      if (this.wordSet.length > 0) {
        ...
        this.audio = new Audio(`/src/assets/data/card/sound/${this.currentWord.id}.mp3`);
        this.audio.play();
